...
const CommercialGasStoveProducts = () => {
  ...
  const products = [
    {
      id: 1,
      name: "3 Burner Commercial Gas Stove",
      images: [
      ...
      description:
        "Designed for heavy-duty commercial use, this 3 Burner Commercial Gas Stove is the perfect solution for restaurants, catering units, food stalls, and commercial kitchens. Built with high-quality stainless steel, it ensures long-lasting durability, hygiene, and consistent performance.",
      features: [
        "2-Color Printing",
    ...
    {
      id: 2,
      name: "Stainless Steel Three Burner Bhatti",
      images: [
        SteelThreeBurnerBhattiImage,
        SteelThreeBurnerBhattiImage,
        SteelThreeBurnerBhattiImage,
        SteelThreeBurnerBhattiImage,
      ],
      description:
        "This Stainless Steel Three Burner Bhatti is built for tough commercial cooking environments, offering reliability, performance, and durability. Designed for continuous use in busy kitchens, it is ideal for preparing a variety of dishes simultaneously with high efficiency.",
      features: [
...
export default CommercialGasStoveProducts;
